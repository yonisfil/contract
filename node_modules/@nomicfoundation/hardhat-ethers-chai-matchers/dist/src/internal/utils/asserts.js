...
export function assertIsNotNull(value, errorMessage) {
    ...
    if (typeof expectedArg === "function") {
        ...
        if (actualArg.hash !== undefined && actualArg._isIndexed === true) {
            if (assertionType !== "event") {
                chaiAssert.fail("Should not get an indexed event when the assertion type is not event. Please open an issue about this.");
            }
...
export function assertCanBeConvertedToBigint(value) {
    chaiAssert.ok(typeof value === "string" ||
        typeof value === "number" ||
