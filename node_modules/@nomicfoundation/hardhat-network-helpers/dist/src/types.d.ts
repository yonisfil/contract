import type { ChainType, DefaultChainType, NetworkConnection } from "hardhat/types/network";
export interface NetworkHelpers<ChainTypeT extends ChainType | string = DefaultChainType> {
    readonly time: Time;
    /**
...
export type Fixture<T, ChainTypeT extends ChainType | string> = (connection: NetworkConnection<ChainTypeT>) => Promise<T>;
