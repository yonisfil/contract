 ...
 */
export function hasOfficialArm64Build(version) {
 ...
 */
export function hasArm64MirrorBuild(version) {
    return (semver.gte(version, FIRST_ARM64_MIRROR_SOLC_VERSION) === true &&
 ...
 */
export function missesSomeOfficialNativeBuilds() {
...
export function getEvmVersionFromSolcVersion(solcVersion) {
